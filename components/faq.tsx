    ...
    <section className="bg-white pb-14  px-4 md:px-14">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-2">
        ...
        <div className="flex flex-col   gap-6">
          ...
          <p className="font-inter text-gray-500 text-md leading-relaxed md:max-w-md">
            Check out our most frequently asked questions below to find out more
            about our premium rental services, policies, and more.
          </p>
        </div>
