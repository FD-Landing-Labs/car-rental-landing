export default function About() {
  ...
  return (
    <section className="bg-white py-20 px-4 md:px-2 container mx-auto">
      <div className="flex flex-col md:flex-row justify-between items-start gap-12 mb-24">
        {/* Left Side - Headline */}
        <div className="w-full md:w-1/2">
          <h2 className="font-header text-5xl md:text-5xl leading-[1.1] text-black">
        ...
        <div className="flex flex-col w-full md:w-8/12  gap-4">
          <p className=" text-black text-xl leading-relaxed font-medium">
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-2 border-t border-gray-300 pt-6">
